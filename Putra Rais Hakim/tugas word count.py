...
data_komentar = [
    "saya ingin bekerja dengan senang",
    "senang sekali dapat nilai bagus",
    "saya kurang suka dengan ini",
    "bagus banget nilai kamu ini",
    "nilai kamu sempurna banget",
    "biasa saja saya ingin menjadi tidak sempurna",
    "mangan nasi karo ketan enak banget"
]
